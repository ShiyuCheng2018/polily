...
def render_candidate_json(candidate: ScoredCandidate) -> str:
    ...
    data = {
        ...
        "structure_score_breakdown": {
            ...
            "probability_zone": s.probability_zone,
            "liquidity_depth": s.liquidity_depth,
            "exitability": s.exitability,
            "catalyst_proxy": s.catalyst_proxy,
            "small_account_friendliness": s.small_account_friendliness,
        },

...
is auto-discovered as a market type plugin.
...
3. Expose as: plugin = YourPlugin()
4. Add keywords + scoring_overrides in config.yaml under market_types.<name>
"""

from scanner.market_types.registry import discover_plugins, get_plugin

__all__ = ["discover_plugins", "get_plugin"]
